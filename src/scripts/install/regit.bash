...
REGIT_DIR_NAME="regit_Linux_x86_64"
REGIT_TAR_NAME="$REGIT_DIR_NAME.tar.gz"
REGIT_LINK="https://github.com/woaitsAryan/regit/releases/latest/download/$REGIT_TAR_NAME"
